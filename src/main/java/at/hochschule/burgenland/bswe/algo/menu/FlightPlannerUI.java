...
import at.hochschule.burgenland.bswe.algo.search.FlightSearch;
import at.hochschule.burgenland.bswe.algo.search.SearchResult;
import at.hochschule.burgenland.bswe.algo.util.DataLoader;
...
public class FlightPlannerUI {
  ...
  private void handleSearch() {
    ...
    SearchResult result = switch (searchType) {
