...
public class Route {
  ...
  /**
   * Retrieves the list of flight IDs associated with this route.
   *
   * @return a list of integers representing the flight IDs that make up this route
   */
  ...
  /**
   * Retrieves the total duration of the route in minutes.
   *
  ...
  /**
   * Retrieves the total price of the route.
   *
  ...
  /**
   * Retrieves the number of stopovers in this route.
   *
   * @return the number of stopovers
   */
